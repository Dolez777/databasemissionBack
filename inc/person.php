...
?> 
    ...
    <form action="person.php" method="post">
        <label for="firstname" class="m-1">Etunimi:</label>
        <br>
        <input type="text" name="firstname" id="firstname" class="m-1">
        <br>
        <label for="lastname" class="m-1">Sukunimi:</label>
        <br>
        <input type="text" name="lname" id="lastname" class="m-1">
        <br>
